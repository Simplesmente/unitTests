...
class CollectionTest extends \PHPUnit_Framework_TestCase
{
	...
	public function collection_is_intance_of_iterator_aggregate()
	{
		$collection = new \App\Support\Collection();
	...
	public function collection_can_be_merged_with_another_collection()
	{
		...
		//$collectionMerged = $collection1->merge($collection2);
		//
	...
	public function return_json_encoded_items()
	{
		$collection =  new \App\Support\Collection([
			...
			['username' => 'simplemente'],
			
			['username' => 'jhonnyblayzer']
			
		]);

		$this->assertInternalType('string',$collection->toJson());
		
		$this->assertEquals('[{"username":"simplemente"},{"username":"jhonnyblayzer"}]',$collection->toJson());
	}
